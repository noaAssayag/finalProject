...
public class AlertDialogFragmentAddHost extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
                    ...
                    if (reNewValField != null && !(reNewValField.getText().toString().isEmpty())) {
                        ...
                        if (password.equals(rePassword)) {
                            if(!password.equals(user.getPassword())) {
                                ...
                                mListener.onDialogPositiveClick(AlertDialogFragmentAddHost.this);
                            }else {
        ...
        cancelBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mListener.onDialogNegativeClick(AlertDialogFragmentAddHost.this);
                dismiss();
            }
        });
        return v;
